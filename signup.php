...
<!--check if post req contains our post data -->
<?php
...
if (!ctype_digit($contact_number)){
  ...
  // $sql = "INSERT INTO users VALUES (username = '$username', email = '$email', password = '$password', contact_number = '$contact_number', address = '$address')";
	$sql = "INSERT INTO users (username, email, password, contact_number, address) VALUES ('$username', '$email', '$password', $contact_number, '$address')";
